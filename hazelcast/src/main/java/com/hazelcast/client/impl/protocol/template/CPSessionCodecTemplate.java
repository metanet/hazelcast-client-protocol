...
public interface CPSessionCodecTemplate {
    ...
    Object createSession(Data groupId, String endpointName);
    ...
    Object closeSession(Data groupId, long sessionId);
    ...
    Object heartbeatSession(Data groupId, long sessionId);
