...
public interface CPAtomicRefCodecTemplate {
     ...
     * @param returnValueType Denotes type of the value to be returned
    ...
    Object apply(Data groupId, String name, Data function, int returnValueType, boolean alter);
    ...
    Object compareAndSet(Data groupId, @Nullable String name, @Nullable Data oldValue, @Nullable Data newValue);
    ...
    Object contains(Data groupId, String name, @Nullable Data value);
    ...
    Object get(Data groupId, String name);
    ...
    Object set(Data groupId, String name, @Nullable Data newValue, boolean returnOldValue);
