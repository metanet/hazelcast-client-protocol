...
public interface CPCountDownLatchCodecTemplate {
    ...
    Object trySetCount(Data groupId, String name, int count);
    ...
    Object await(Data groupId, String name, Data invocationUid, long timeout);
    ...
    void countDown(Data groupId, String name, Data invocationUid, int expectedRound);
    ...
    Object getCount(Data groupId, String name);
    ...
    Object getRound(Data groupId, String name);
